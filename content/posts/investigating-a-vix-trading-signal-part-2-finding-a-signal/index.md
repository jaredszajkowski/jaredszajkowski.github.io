...
summary: A brief look at finding a trading signal based on moving averages of the VIX.
...
Continuing from where we left off in [part 1](/posts/investigating-a-vix-trading-signal-part-1-vix-and-vvix/), we will now consider the idea of a spike level in the VIX and how we might use a spike level to generate a signal. These elevated levels usually occur during market sell-off events or longer term drawdowns in the S&P 500. Sometimes the VIX reverts to recent levels after a spike, but other times levels remain elevated for weeks or even months.
...
The most recent yearly plots are shown below for when signals are generated. The images for the previous years are also linked below.
