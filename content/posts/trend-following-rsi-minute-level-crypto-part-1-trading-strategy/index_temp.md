---
title: "Combining Trend Following With RSI Using Crypto Data, Part 1: Developing A Trading Strategy"
description: Implementing a trading strategy using minute level crypto data, with a trend following filter.
slug: trend-following-rsi-minute-level-crypto-part-1-trading-strategy
date: 2025-07-27 00:00:01+0000
lastmod: 2025-07-27 00:00:01+0000
feature: cedrik-wesche-wbvW4jvulsQ-unsplash.jpg
coverCaption: Photo by <a href="https://unsplash.com/@cedrikwesche?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Cedrik Wesche</a> on <a href="https://unsplash.com/photos/black-and-white-digital-device-wbvW4jvulsQ?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
draft: true
categories:
    - Coinbase
    - Pandas
...
In this post, we will look into developing a trading strategy that implements the following ideas:

* Crypto data at the minute level
* Using RSI to determine overbought/oversold conditions
* Overlaying a trend following strategy to determine optimal usage of RSI
