...
I have recently started trading based on the ideas from [part 2](/posts/investigating-a-vix-trading-signal-part-2-finding-a-signal/), using the following as guidelines:
